...
public class EventTakePendant extends Event implements ChooseMenu {
    ...
    private void readMessage(Persona character) {
        ...
        switch (readMessage.nextLine().toLowerCase()) {
            case "oui", "o", "yes", "y" -> {
                System.out.println("Vous dépliez le papier. Il est écrit : \"Vous qui avez vaincu mon animal favoris, le cerbère de mon antre, sachez qu'une chose ... Oeil pour oeil, dent pour dent.\"");
